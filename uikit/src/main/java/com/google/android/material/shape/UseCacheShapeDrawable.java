...
public class UseCacheShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {

  private static final String TAG = UseCacheShapeDrawable.class.getSimpleName();
   ...
   */
  @NonNull
  public static UseCacheShapeDrawable createWithElevationOverlay(Context context) {
   ...
   */
  @NonNull
  public static UseCacheShapeDrawable createWithElevationOverlay(Context context, float elevation) {
    int colorSurface =
        MaterialColors.getColor(
            context, R.attr.colorSurface, UseCacheShapeDrawable.class.getSimpleName());
    UseCacheShapeDrawable materialShapeDrawable = new UseCacheShapeDrawable();
  ...
  @Deprecated
  public UseCacheShapeDrawable(@NonNull ShapePathModel shapePathModel) {
  ...
  static final class MaterialShapeDrawableState extends ConstantState {
    ...
    public Drawable newDrawable() {
      UseCacheShapeDrawable msd = new UseCacheShapeDrawable(this);
