...
public class LruBitmapPool implements BitmapPool {
    ...
    private LruBitmapPool(long maxSize, LruPoolStrategy strategy, Set<Bitmap.Config> allowedConfigs) {
    ...
    public LruBitmapPool(long maxSize) {
        this(maxSize, new SizeConfigStrategy(), getDefaultAllowedConfigs());
    }
